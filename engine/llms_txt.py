...
> Local AI engine for Mac with LLM, TTS, STT, and image generation. Ollama-style model management.
...
- **Models**: LLM, TTS, STT, image (Stable Diffusion), vision. Add custom models via POST /models with HuggingFace repo.
